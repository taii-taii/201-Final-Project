...
CREATE TABLE `Documents` (
  ...
  `DocumentContent` varchar(8000) DEFAULT NULL,
...
INSERT INTO `Documents` (documentID, DocumentName) VALUES ('abc123','GE Essay'),('def456','Project Proposal'),('ghi789','SQL Database Schema'),('hsnrqhiody','SOCI 155 Final Essay'),('ixgdcihgvo','Recipes'),('jkl012','Backend Code'),('waowaiyrjx','My TODO List');
